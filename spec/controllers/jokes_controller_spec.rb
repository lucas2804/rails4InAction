...
RSpec.describe JokesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all jokes as @jokes" do
      ...
      expect(assigns(:jokes)).to eq([joke])
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created joke as @joke" do
        post :create, {:joke => valid_attributes}, valid_session
        expect(assigns(:joke)).to be_a(Joke)
        expect(assigns(:joke)).to be_persisted
      end

      it "redirects to the created joke" do
        post :create, {:joke => valid_attributes}, valid_session
        expect(response).to redirect_to(Joke.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved joke as @joke" do
        post :create, {:joke => invalid_attributes}, valid_session
        expect(assigns(:joke)).to be_a_new(Joke)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested joke" do
        joke = Joke.create! valid_attributes
        put :update, {:id => joke.to_param, :joke => new_attributes}, valid_session
        joke.reload
      ...
      it "redirects to the joke" do
        joke = Joke.create! valid_attributes
        put :update, {:id => joke.to_param, :joke => valid_attributes}, valid_session
        expect(response).to redirect_to(joke)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the joke as @joke" do
        joke = Joke.create! valid_attributes
        put :update, {:id => joke.to_param, :joke => invalid_attributes}, valid_session
        expect(assigns(:joke)).to eq(joke)
      end
